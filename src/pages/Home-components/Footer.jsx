        ...
        <div>
            ...
            <div className="bg-[#111827] md:flex relative justify-between ">
                    <div className="md:w-[600px] border-b border-oran">
                        <p className="text-white break-words md:m-5 md:p-0 p-5 text-sm">Welcome to our law program! We are proud to offer a comprehensive and innovative curriculum that prepares students for success in the legal field. Our program is designed to provide students with a solid foundation in the law, while also emphasizing practical skills and real-world experience..</p>
                    </div>
